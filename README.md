...
RaidCalendar lets you view and sign up to raids in game on https://raid-helper.xyz/ and register soft reserves on https://raidres.top
...
* Sign up/change role on guilds raids from https://raid-helper.xyz/
...
> [!NOTE]
> When you soft reserve using RaidCalendar this is done with a Discord account setup by the bot owner. Any changes will have to be done with RaidCalendar as they will not be avaible for you to edit on https://raid-helper.xyz/.
