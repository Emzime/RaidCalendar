...
local function get_addon_locale()
    ...
    if locale == "Francais" or locale == "Fran\195\167ais" or locale == "French" then
        return "frFR"
    end
...
local RAID_LIST = {
    { is_header = true, text = "\226\148\128\226\148\128 40-man \226\148\128\226\148\128" },
    ...
    { is_header = true, text = "\226\148\128\226\148\128 20-man \226\148\128\226\148\128" },
    { value = 98,  text = "Ruins of Ahn'Qiraj" },
    { value = 115, text = "Timbermaw Hold" },
    { value = 100, text = "Zul'Gurub" },
    { is_header = true, text = "\226\148\128\226\148\128 10-man \226\148\128\226\148\128" },
    { value = 101, text = "Lower Karazhan Halls" },
    { value = 106, text = "Upper Blackrock Spire" },
    { is_header = true, text = "\226\148\128\226\148\128 World Boss \226\148\128\226\148\128" },
